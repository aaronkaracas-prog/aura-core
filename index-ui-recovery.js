...
const BUILD = "AURA_CORE__UI_RECOVERY__2026-02-01";
...
header{padding:12px;border-bottom:1px solid #222}
main{max-width:900px;margin:0 auto;padding:16px}
#log{white-space:pre-wrap;min-height:300px}
</style>
</head>
<body>
<header>
<strong>Aura Core</strong>
<div>Build: ${BUILD} • ${BUILD_TS} • Worker</div>
</header>
<main>
<div id="log"></div>
<input id="q" placeholder="Type command"/><button onclick="send()">Send</button>
</main>
<script>
async function send(){
 ...
 document.getElementById('log').textContent += "> "+q+"\n"+t+"\n\n";
}
</script>
</body>
</html>`;
...
export default {
  async fetch(request, env) {
    ...
    // ----------------------------
const BUILD = "AURA_CORE__AUTONOMY_LAYERS__EVIDENCE_ALLOWLIST_HOSTCAPS_OPERATOR_INTENT_PAUSE__MEMORY_SUBSTRATE_V1__REGISTRY_AUDIT__13__CF_DNS__01";
