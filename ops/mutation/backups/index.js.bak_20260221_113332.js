...
const __selfPatchTransform_v1 = (supported, ctx) => {
  try {
...
"PATCH_OBJECT_GET", { ok: true, host, count: bounded.length });
  ...
  continue;
    ...
    if (line === "SELF_PATCH_APPLY") {
      ...
      const supported = (() => {
        try {
          const o = intent && intent.intent && intent.intent.obj ? intent.intent.obj : null;
          const n1 = o && o.intent && o.intent.name;
          const n2 = o && o.intent && o.intent.obj && o.intent.obj.intent && o.intent.obj.intent.name;
          const n3 = o && o.intent && o.intent.obj && o.intent.obj.intent && o.intent.obj.intent.obj && o.intent.obj.intent.obj.intent && o.intent.obj.intent.obj.intent.name;
          const v = n1 || n2 || n3;
      ...
      if (!intent) {
        ...
        continue;
            ...
            const supported = intent && intent.intent && intent.intent.obj && intent.intent.obj.intent && intent.intent.obj.intent.name ? String(intent.intent.obj.intent.name) : null;
      const result = __selfPatchTransform_v1(supported, { activeHost, key, intent });
      if (result) {
