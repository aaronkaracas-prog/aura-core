  ...
  return jsonReply(out);
    ...
    if (line === "RUN_SELF_TEST_EVIDENCE") {
      try {
        ...
        // runSelfTestEvidence returns jsonReply(JSON.stringify(...)) => Response
        ...
        push("RUN_SELF_TEST_EVIDENCE", { ok: true, host: String(activeHost || "").toLowerCase(), stamp: new Date().toISOString(), payload });
      } catch (e) {
