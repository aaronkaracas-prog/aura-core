    ...
    if (__kind === "patch_mutation_v1" && __target === "source_only") {
      return {
        stage: "PHASE5_SOURCE_MUTATION_APPLIED",
                  patch: { index_id: parsed.body && parsed.body.index_id ? parsed.body.index_id : null },
                  receipt: {
                    ts: new Date().toISOString(),
                    type: "PHASE5_SOURCE_ONLY_MUTATION",
                    note: "Deterministic marker appended to SOURCE_CODE_ACTIVE."
                  },
        patch: {
          index_id: idxId,
          object_id: objId,
