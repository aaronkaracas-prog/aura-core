...
if (line === "SELF_PATCH_PUT") {
  ...
  try {
    ...
    if (line === "SELF_PATCH_EXECUTE") {
      ...
      if (result) {
        push("SELF_PATCH_EXECUTE", { ok:true, host:activeHost, key, intent, stage:"EXECUTE_WIRED_NOOP", ...result, receipt:{ ts:new Date().toISOString(), type:"SELF_PATCH_EXECUTE_V1", note:"Execute wired; no mutation executed (phase 1)." } });
        continue;
      }
