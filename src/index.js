...
// AURA_CORE__2026-01-23__AUTONOMY_STEP_61__CITYGUIDE_CORS__01
// Full-file replacement. DO NOT MERGE.
// UI: STEP 11 preserved.
// Adds CORS for browser-based CityGuide.Pages fetches.

const BUILD_VERSION = "AURA_CORE__2026-01-23__AUTONOMY_STEP_61__CITYGUIDE_CORS__01";
const BUILD_STAMP = "2026-01-23 22:30 PT";
...
export default {
  async fetch(req, env) {
    ...
    // CORS preflight (needed for Pages -> Aura fetch)
