...
<title>Aura Core ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ UI</title>
...
<div class="app">
  ...
  <main class="main">
    ...
    <div class="composerWrap">
      <div class="composer">
        <button id="attachBtn" class="iconBtn" title="Attach">Ã¢Â¤â€™</button>
        <button id="micBtn" class="iconBtn" title="Mic">Ã°Å¸Å½â„¢</button>
