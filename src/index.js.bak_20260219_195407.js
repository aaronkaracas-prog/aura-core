...
const BUILD = 'AURA_CORE__AUTONOMY_LAYERS__EVIDENCE_ALLOWLIST_HOSTCAPS_OPERATOR_INTENT_PAUSE__MEMORY_SUBSTRATE_V1__REGISTRY_AUDIT__19__AUTO_RUNTIME_TEST__01';
...
<title>Aura Core ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ UI</title>
...
<div class="app">
  ...
  <main class="main">
    ...
    <div class="composerWrap">
      <div class="composer">
        <button id="attachBtn" class="iconBtn" title="Attach">ÃƒÂ¢Ã‚Â¤Ã¢â‚¬â„¢</button>
        <button id="micBtn" class="iconBtn" title="Mic">ÃƒÂ°Ã…Â¸Ã…Â½Ã¢â€žÂ¢</button>
...
(function(){
  ...
  async function micStart(){
    ...
    try{
      ...
      micState = 'idle';
      addBubble('sys', 'Mic FAIL: ' + micLastError.name + ' Ã¢â‚¬â€ ' + micLastError.message, true);
    }
  }
  ...
  if(attachBtn){
    attachBtn.addEventListener('click', ()=>{
      showOverlay('Attach', 'File upload is next. This is the UI shell step ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â no upload logic yet.');
    });
  }
  if(micBtn){
